		...
		"WIDGET_BUTTON": BEGIN
			...
			CASE ename OF
				...
				"AVE_WFB" : BEGIN
					...
					IF u.B.wf THEN widget_control,u.id.message,set_value='white field calibration enabled' ,/app
					IF NOT u.B.wf THEN widget_control,u.id.message,set_value='white field calibration disabled' ,/app
				END
				"FITSPEC" : BEGIN
					WIDGET_CONTROL,/hourglass
				...
				"INVERT" : BEGIN
					WIDGET_CONTROL,/hourglass
					hirexsr_invert2tree,u.shot,u.line,rhovec=*u.dat.rho,good=*u.dat.good,sine=u.inv.sine,tht=u.tht,nosub=u.inv.nosub	
...
PRO w_thaco,shot=shot,tht=tht,line=line
	...
	inv={rho:'default RHOVEC will be used',nr:25,rmax:0.95,psin:0,ra:1,rmid:0,min:0,max:0,bad:'all channels used for inversion',sine:1,nosub:0}
